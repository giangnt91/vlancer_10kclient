...
.controller('HomeCtrl', function ($rootScope, $scope, $location, $window, $timeout, DataServices, socialLoginService, $filter, Thesocket) {
    ...
    //DataServices.signIn('974804119351311', 'https://graph.facebook.com/974804119351311/picture?width=180&height=180').then(function (signin_res) {
    //    var signin_result = signin_res.data;
    //    if (signin_result.error_code === 0) {
    ...
    $scope.testNotif = function () {
        Thesocket.emit('user_get_coupon', $scope.auth[0].user_id, '454545454545454', 'Cơm Tấm Calimina');
    }
